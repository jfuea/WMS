...
export interface IProductItemClient {
    create(command: CreateProductItemCommand): Observable<number>;
    update(id: number, command: UpdateProductItemCommand): Observable<number>;
    delete(id: number): Observable<number>;
    updateProductDetail(id: number | undefined, command: UpdateProductItemDetailCommand): Observable<number>;
}

@Injectable({
    providedIn: 'root'
})
export class ProductItemClient implements IProductItemClient {
    ...
    create(command: CreateProductItemCommand): Observable<number> {
        let url_ = this.baseUrl + "/api/ProductItem";
        url_ = url_.replace(/[?&]$/, "");
    ...
    update(id: number, command: UpdateProductItemCommand): Observable<number> {
        let url_ = this.baseUrl + "/api/ProductItem/{id}";
    ...
    updateProductDetail(id: number | undefined, command: UpdateProductItemDetailCommand): Observable<number> {
        let url_ = this.baseUrl + "/api/ProductItem/UpdateProductDetail?";
        if (id === null)
        ...
        return this.http.request("put", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processUpdateProductDetail(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processUpdateProductDetail(<any>response_);
                } catch (e) {
                    return <Observable<number>><any>_observableThrow(e);
                }
            } else
    ...
    protected processUpdateProductDetail(response: HttpResponseBase): Observable<number> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export interface IProductListClient {
    get(): Observable<ProductsVm>;
    create(command: CreateProductListCommand): Observable<number>;
    update(id: number, command: UpdateProductListCommand): Observable<FileResponse>;
...
export class ProductListClient implements IProductListClient {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    get(): Observable<ProductsVm> {
        let url_ = this.baseUrl + "/api/ProductList";
        url_ = url_.replace(/[?&]$/, "");
    ...
    update(id: number, command: UpdateProductListCommand): Observable<FileResponse> {
        let url_ = this.baseUrl + "/api/ProductList/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
...
export class UpdateProductItemDetailCommand implements IUpdateProductItemDetailCommand {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.internalReference = _data["internalReference"];
            this.barcode = _data["barcode"];
            this.notes = _data["notes"];
            this.weight = _data["weight"];
            this.volume = _data["volume"];
            this.customerLeadTime = _data["customerLeadTime"];
            this.quantity = _data["quantity"];
            this.quantityForecasted = _data["quantityForecasted"];
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["cost"] = this.cost;
        data["internalReference"] = this.internalReference;
        data["barcode"] = this.barcode;
        data["notes"] = this.notes;
        data["weight"] = this.weight;
        data["volume"] = this.volume;
        data["customerLeadTime"] = this.customerLeadTime;
        data["quantity"] = this.quantity;
        data["quantityForecasted"] = this.quantityForecasted;
        return data; 
    }
}
...
export class ProductsVm implements IProductsVm {
    lists?: ProductListDto[] | undefined;
...
export class ProductItemDto implements IProductItemDto {
    ...
    init(_data?: any) {
        if (_data) {
            this.id = _data["id"];
            this.list = _data["list"] ? ProductList.fromJS(_data["list"]) : <any>undefined;
            this.listId = _data["listId"];
            this.name = _data["name"];
            this.type = _data["type"];
            this.note = _data["note"];
...
export class ProductList extends AuditableEntity implements IProductList {
    id?: number;
    title?: string | undefined;
    ...
    init(_data?: any) {
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["items"])) {
                this.items = [] as any;
                for (let item of _data["items"])
                    this.items!.push(ProductItem.fromJS(item));
            }
        }
    }
...
export interface IProductList extends IAuditableEntity {
    id?: number;
    title?: string | undefined;
    items?: ProductItem[] | undefined;
}

export class ProductItem extends AuditableEntity implements IProductItem {
    id?: number;
    list?: ProductList | undefined;
    listId?: number;
    name?: string | undefined;
...
export interface IProductItem extends IAuditableEntity {
    id?: number;
    list?: ProductList | undefined;
    listId?: number;
    name?: string | undefined;
